...
enum Errors readFile(RouteList* list, const char* filename) {
...
int main() {
    ...
    proccesFile(&list, 3, "task6_test/stop1.txt", "task6_test/stop2.txt", "task6_test/stop3.txt");
